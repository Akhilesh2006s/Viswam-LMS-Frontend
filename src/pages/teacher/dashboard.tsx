...
const TeacherDashboard = () => {
  ...
  const [dashboardSubTab, setDashboardSubTab] = useState<
    'ai-classes' | 'students' | 'eduott' | 'learning-paths'
  >('ai-classes');
  ...
  type DashboardSubTab = 'ai-classes' | 'students' | 'eduott' | 'learning-paths';
  ...
  return (
    <div className="min-h-screen bg-sky-50 relative overflow-x-hidden">
      ...
      <div className="bg-[var(--brand-navy)] text-white shadow-xl border-b-0 rounded-b-3xl sticky top-0 z-50 relative">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold">VISWAM LMS</h1>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 pb-28 lg:pb-8 relative z-10">
        ...
        <div className="space-y-4 sm:space-y-6 lg:space-y-8">
          {/* Dashboard Sub-Tabs — desktop / large tablet (in page flow) */}
              <div className="hidden lg:block viswam-sidebar rounded-3xl p-4 shadow-xl border border-orange-300 overflow-x-auto teacher-dashboard-nav-scroll">
                {dashboardSubTabNav}
              </div>
              ...
              {dashboardSubTab === 'ai-classes' && (
                <>
              {/* Stats Cards — Dashboard only (hidden on My Students, EduOTT) */}
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 pointer-events-none px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
        <div className="pointer-events-auto relative w-full min-w-0 max-w-full viswam-sidebar rounded-3xl px-2.5 pt-2.5 pb-1.5 shadow-xl border border-orange-300">
          <div
